            ...
            <a-form :model="form" type="submit" @finish="getData" class="flex flex-col gap-y-3">
              ...
              <a-form-item>
                <a-button
                  html-type="submit"
                  block
                  class="rounded-md font-semibold py-4 flex items-center justify-center border border-primary bg-blue-500 text-white hover:bg-white hover:text-primary hover:border-primary"
                >
                  SIGN IN
                </a-button>
              </a-form-item>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      const res = await axios.get('http://175.176.161.67:7557/devices')
      console.log(res)
    }
  }
}
